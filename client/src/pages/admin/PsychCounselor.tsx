  ...
  return (
    <div className="flex flex-col items-center min-h-screen p-4" dir="rtl">
      <div className="w-full max-w-5xl bg-white shadow rounded-2xl p-8 space-y-8">
        <h1 className="font-bold text-xl text-center">مشاوره روانشناختی</h1>
        <div>
        ...
        {student && (
          <Card className="border-gray-200 shadow-sm">
            <CardContent className="p-6 space-y-6">
              <h2 className="font-semibold text-md text-gray-800">ثبت گزارش مشاوره روانشناختی</h2>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="متن گزارش مشاوره روانشناختی را وارد کنید"
